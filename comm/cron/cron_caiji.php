...
if($collect['laiyuan']==2){
	...
	$url=$collect['api_url']."&caiji_time=".$caiji_time."&sprice=".$collect['sprice']."&eprice=".$collect['eprice']."&page=".$page."&page_size=".$page_size.'&key='.md5(DDYUNKEY).'&domain='.urlencode(DOMAIN)."&cid=".implode(',',$yun_cid_arr).'&yasuo='.$yasuo;
