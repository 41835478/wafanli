...
class ddTaoapi extends Taoapi{
	...
	function get_et(){
		/*$url='http://g.click.taobao.com/load?rf='.urlencode(SITEURL).'&dr=&pid='.$pid.'&pgid='.$pgid.'&ak=&ttype=1&iframe=false&st=1433493053370%2C1433493053372&lan=0%2C1&ciid=44304181548&csid=&curl=&ckeywords=&cbh=361&cbw=1440&re=1440x900&cah=860&caw=1440&ccd=32&ctz=8&chl=9&cja=1&cpl=31&cmm=54&cf=11.3&cb=jsonp_callback_05700072422623634';
		$a = dd_get($url);
	...
	function taobao_tbk_shop_recommend_get($user_id,$count){
