...
if($goods['laiyuan_type']==1||$goods['laiyuan_type']==2){
	...
	$goods['shop_jump']=u('jump','shop',array('user_id'=>$tao_goods['ds_user_id'],'nick'=>$tao_goods["ds_nick"]));
}
    ...
    <div class="shopright" style=" *margin-bottom:-10px;">
      <div class="biaozhun1" style="float:none;">
        ...
        <div class="shopitem_main" style="*padding-bottom:15px;">
          <div class="shopitem_main_l"> <a class="spimng" target="_blank" href="<?=$goods['jump']?>" ><img id="goodspic" src="images/310.gif" alt="<?=$goods['title']?>" /></a>
          ...
          <div class="shopitem_main_r" style="position:relative;">
            ...
            <div class="shopitem_main_r_4" style="margin-top:15px">
             ...
             <?php }else{?>
            <div class="shopitem_main_r_4" style="margin-top:15px;"><a target="_blank" href="<?=$goods['jump']?>" ><img alt="立刻去购买" src="<?=TPLURL?>/inc/images/n_gomai.gif" /></a>
              <?php if($goods['laiyuan_type']<=2){?>
              <a target="_blank" href="<?=$goods['shop_jump']?>" ><img alt="逛逛掌柜店铺" src="<?=TPLURL?>/inc/images/gozhanggui.gif" /></a>
              <?php }?>
            </div>
           <?php }?>
