...
$pagesize=100;
$url=DD_FANLICHENG_URL.'/api.php?mod=collect_api&act=mall&page='.$page.'&page_size='.$pagesize.'&url='.urlencode(get_domain(SITEURL)).'&key='.md5(DDYUNKEY)."&field=".$mall_field;
